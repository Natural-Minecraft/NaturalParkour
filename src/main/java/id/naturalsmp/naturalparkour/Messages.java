...
public class Messages {
	...
	public Messages(Main pl) {
		...
		msgDefaults.put("setup-done", "&aYou can now do &2/naturalparkour start&a to do parkour!");
		...
		msgDefaults.put("errors.blocknotair.admin",
				"&6Make sure the parkour area is completly air, and that the plugin has been correctly set up by reading /{CMD} setup.");
		...
		msgDefaults.put("errors.too-many-players",
				"&cThere are too many players in parkour right now. Try again later.");
		...
		msgDefaults.put("commands.help.header", "&aNaturalParkour made by &2NaturalDev&a!");
		...
		msgDefaults.put("commands.help.startothers",
				"&6 /{CMD} start <player> [area] &7- &9Start another player's parkour in a certain area.");
		msgDefaults.put("commands.help.top", "&6 /{CMD} top &7- &9See the top 10 players!");
		msgDefaults.put("commands.help.list",
				"&6 /{CMD} list &7- &9See everyone that is playing parkour, and their current scores.");
		msgDefaults.put("commands.help.setup",
				"&6 /{CMD} setup &7- &9Commands for setting up the plugin. &7(required permssion: NaturalParkour.setup)");
		...
		msgDefaults.put("commands.setup.we",
				"&6 /{CMD} setup we &7- &9Select first and second position with worldedit");
		...
		msgDefaults.put("commands.setup.max",
				"&6 /{CMD} setup max &7- &9Set the maximum number of people allowed in the area!");
		msgDefaults.put("commands.setup.save",
				"&6 /{CMD} setup save &7- &9Saves and enabled the area. (This should be done last)");
		...
		msgDefaults.put("setup.we.not-installed",
				"&cYou need to have WorldEdit installed to use this command!&7 Try using the built-in pos1 and pos2 setup commands.");
		msgDefaults.put("setup.we.incomplete-selection",
				"&cYou must make a complete worldedit selection before doing this!");
		msgDefaults.put("setup.created",
				"&aArea created and added to the editing queue. See &2/NaturalParkour setup&a or view the plugin page for steps to set it up!");
		msgDefaults.put("setup.already-creating",
				"&cAn arena is currently being set up. &aPlease either save that arena, or run this command again to override. (&c&lNOTE:&r&c Overriding will erase all of the data of the arena being set up before!)");
		...
		msgDefaults.put("setup.diff.not-valid",
				"&cInvalid difficulty! &7Valid difficulties are &feasy&7, &fmedium&7, &fhard&7, &fexpert&7, and &fbalanced");
		msgDefaults.put("setup.diff.need-args",
		...
		msgDefaults.put("setup.save.not-done",
				"&cYou have not set all of the required settings! &7Check &f/{CMD} setup info&7 to see what you have left.");
		msgDefaults.put("setup.save.success", "&aArena {NAME} saved and loaded!");
		msgDefaults.put("setup.area.too-small",
		...
		msgDefaults.put("portals.create.success",
				"&aCreated a portal named '{NAME}' at your current location! &7You might have to restart the server for the portal to start working.");
		msgDefaults.put("portals.remove.help", "&cPlease enter the name of the portal to be removed!");
		msgDefaults.put("portals.remove.cannot-find",
				"&cCannot find a portal with that name! Make sure you spelled it correctly, and that you put the same caps too.");
		msgDefaults.put("portals.remove.success", "&aRemoved portal '{NAME}'!");
		msgDefaults.put("portals.remove.no-portals",
				"&cNo portals have been set up yet! Please create portals before removing them.");
		...
		msgDefaults.put("areas.remove.cannot-find",
				"&cCannot find an area with that name! Make sure you spelled it correctly, and that you put the same caps too.");
